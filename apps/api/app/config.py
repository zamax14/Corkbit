...
class Settings(BaseSettings):
    ...
    database_url: str = "sqlite:///./crokbit.db"
    root_path: str = ""
    public_base_url: HttpUrl = HttpUrl("http://localhost:5173")
    cors_origins: list[str] = ["http://localhost:5173"]
    wip_limit: int = Field(default=5, ge=1)
    agent_token: str = ""
    # Emisor del realm de Keycloak, p. ej. http://localhost:8081/realms/crokbit
    oidc_issuer: str = ""
    oidc_audience: str = "crokbit-api"
    oidc_client_id: str = "crokbit-web"
